        ...
        <div className="flex flex-col w-full  items-center h-full">
            ...
            <div className="h-3/4 flex flex-col justify-evenly w-full">
                <form className=" h-full flex flex-col justify-evenly w-full">
                    ...
                    <input placeholder="Descripcion" className="input input-bordered" value={pregunta?.Descripcion} />
                    <input placeholder="Numero Pregunta" className="input input-bordered" value={pregunta?.NumPregunta} />
